 ...
 * @author ebubekir
 */
public class yetkili_kyt extends javax.swing.JFrame {

    /**
     * Creates new form yetkili_kyt
     */
    public yetkili_kyt() {
        initComponents();
    }
...
baglanti bgl= new baglanti();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try       
          {     
             bgl.baglanti(); 
            CallableStatement calstat=bgl.con.prepareCall("{call yetkili_ekle(?,?,?,?)}");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yetkili_kyt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
